...
Patch(
    ...
    {
        cpw_HistoryLabel: Concatenate(
            locNewSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.Draft.Value),
            " | ",
...
Patch(
    ...
    {
        cpw_HistoryLabel: Concatenate(
            locSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.Approved.Value),
            " | ",
            Text(Now(), "yyyy-mm-dd hh:mm:ss"),
            " | ",
            "Approved by "
...
Patch(
    ...
    Defaults(cpw_StatusHistories),
    {
        cpw_HistoryLabel: Concatenate(
            locSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.ReturnedforCorrection.Value),
            " | ",
            Text(Now(), "yyyy-mm-dd hh:mm:ss"),
            " | ",
...
Patch(
    ...
    Defaults(cpw_StatusHistories),
    {
        cpw_HistoryLabel: Concatenate(
            locSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.PendingApproval.Value),
            " | ",
            Text(Now(), "yyyy-mm-dd hh:mm:ss"),
            " | ",
...
Patch(
    ...
    Defaults(cpw_StatusHistories),
    {
        cpw_HistoryLabel: Concatenate(
            locSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.FlaggedSuspect.Value),
            " | ",
            Text(Now(), "yyyy-mm-dd hh:mm:ss"),
            " | ",
            "Flagged as suspect by "
        ),
        cpw_Survey: locSurvey,
        cpw_FromStatus: locSurvey.cpw_Status,
...
Patch(
    ...
    Defaults(cpw_StatusHistories),
    {
        cpw_HistoryLabel: Concatenate(
            locSurvey.cpw_SurveyId,
            " | ",
            Text('cpw_SurveyStatus'.Published.Value),
            " | ",
            Text(Now(), "yyyy-mm-dd hh:mm:ss"),
            " | ",
            "Published to analysis by "
        ),
        cpw_Survey: locSurvey,
        cpw_FromStatus: locSurvey.cpw_Status,
