    ...
    <div className="min-h-screen bg-background">
      <header className="bg-white border-b border-border px-8 py-6">
        <div className="max-w-[1280px] mx-auto">
          <Breadcrumb items={[
            { label: 'Waters', path: '/' },
            { label: 'South Platte Basin', path: '/water' },
            { label: 'Survey Validation' }
          ]} />
          <div className="flex items-center justify-between mt-3">
            <div>
              <h1 className="text-[22px] font-semibold text-primary">Survey Validation — South Platte Basin</h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[13px] text-muted-foreground mb-1">
                Validating data integrity and protocol compliance for South Platte Basin
              </p>
              <p className="text-[14px] text-foreground">
                <span className="font-medium">Station:</span> <span className="font-mono">SP-04</span>
                <span className="mx-3 text-muted-foreground">|</span>
                <span className="font-medium">Survey Date:</span> Aug 14, 2024
                <span className="mx-3 text-muted-foreground">|</span>
                <span className="font-medium">Protocol:</span> Two-Pass Removal
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[12px] text-muted-foreground">
                Colorado River - Reach 3 (COCOL03) • February 10, 2026
              </span>
            </div>
            <div className="flex items-center gap-6 text-[12px]">
              <div>
                <span className="text-muted-foreground">Survey ID:</span>{' '}
                <span className="font-mono text-foreground">SRV-2026-089</span>
              </div>
              <div>
                <span className="text-muted-foreground">Biologist:</span>{' '}
                <span className="text-foreground">J. Martinez</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <Card className="border border-border shadow-sm bg-muted/30">
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[26px] font-semibold">{data.length}</p>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6 p-4 border border-border/50 bg-muted/20 rounded flex items-start gap-3">
                    ...
                    <div className="text-[11px] text-muted-foreground leading-relaxed">
                      <p className="mb-1.5">
                        <span className="font-medium text-foreground">Population Estimation Method:</span> Two-Pass Removal with Zippin's depletion formula
                      </p>
                      <p>
                  ...
                  <div className="pt-4 border-t border-border">
                    ...
                    <div className="space-y-2 text-[11px]">
                      <div className="flex justify-between">
                        <span className="font-mono text-foreground">RBT</span>
                        <span className="text-muted-foreground">Rainbow Trout</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-mono text-foreground">BNT</span>
                        <span className="text-muted-foreground">Brown Trout</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-mono text-foreground">CTT</span>
                        <span className="text-muted-foreground">Cutthroat Trout</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-mono text-foreground">BKT</span>
                        <span className="text-muted-foreground">Brook Trout</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-mono text-foreground">LND</span>
                        <span className="text-muted-foreground">Longnose Dace</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
